...
// func findRoots(finder file.IFinder, paths []string, exclusions []string) []string {
// 	refiner := Refiner{finder}
// 	files, _ := refiner.refinePaths(paths, exclusions)

// 	gradleSetup, err := GradleSetup.Configure(files, paths)
// 	if err != nil {
// 		return nil, err
// 	}
// 	roots := []string{}
...
// 		roots = append(roots, gradleProject.gradlew)
// 	}
// 	for _, file := range files {
// 		dir, _ := filepath.Abs(filepath.Dir(file))
