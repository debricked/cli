...
func (sf FactoryMock) Make(config config.IConfig, files []string, paths []string, exclusions []string, inclusions []string, finder finder.IFinder, ctx cgexec.IContext) (strategy.IStrategy, error) {
...
func (sf FactoryErrorMock) Make(config config.IConfig, files []string, paths []string, exclusions []string, inclusions []string, finder finder.IFinder, ctx cgexec.IContext) (strategy.IStrategy, error) {
