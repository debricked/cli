...
import (
	...
	"github.com/debricked/cli/internal/resolution/pm/uv/testdata"
...
func TestRunCmdErrExecutableNotFound(t *testing.T) {
	execErr := errors.New("exec: \"uv\": executable file not found in $PATH")
	...
	assert.Contains(t, errs[0].Documentation(), "uv wasn't found")
}
